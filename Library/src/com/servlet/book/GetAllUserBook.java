...
@WebServlet("/getAllUserBook.action")
public class GetAllUserBook extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(Integer.parseInt(request.getParameter("pageIndex"))==0) {
			pageIndex=1;
		}
		List<UserBook> userbooks=bookDao.getAllUserBook(pageIndex);
