...
<script src="http://localhost:8080/Library/style/js/updateCase.js" type="text/javascript" charset="utf-8"></script>
</head>
<body>
<!--头部开始-->
	...
	<div class="main">
		...
		<div class="m-right">
			...
			<input type="hidden" name="id" value="${bookcase.id}" id="id">
				<div class="form-group">
					<label for="exampleInputEmail1">书架名</label> <input
						type="text" class="form-control" id="bookcase" name="bookcase"
						value="${bookcase.bookcase }" onblur="updateBookCase(id)">
				</div>
				
				<input type="hidden" value="${bookcase.bookTypeId }" id="bookTypeId">
