...
<script src="http://localhost:8080/Library/style/js/updateType.js" type="text/javascript" charset="utf-8"></script>
</head>
<body>
<!--头部开始-->
	...
	<div class="main">
		...
		<div class="m-right">
			...
			<input type="hidden" name="id" value="${booktype.id}" id="id">
				<div class="form-group">
					<label for="exampleInputEmail1">类型名</label> <input
						type="text" class="form-control" id="name" name="name"
						value="${booktype.name }" onblur="updateBookType(id)">
				</div>
