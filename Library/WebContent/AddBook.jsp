...
<script src="http://localhost:8080/Library/style/js/AddBook.js" type="text/javascript" charset="utf-8"></script>
</head>
<body>
<!--头部开始-->
		...
		<div class="m-right">
			...
			<form id="myForm">
				...
				<div class="form-group">
					...
					<img id="imgbase64" src="" style="width:300px;height:auto;margin-top:10px">
				</div>
				<div class="form-group">
...
<button  onclick="AddBook()" class="btn btn-primary">添加图书</button></div>
		</div>
	</div>
